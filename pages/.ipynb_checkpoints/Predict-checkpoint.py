...
lottie_predict = load_lottieurl(
    "https://lottie.host/ed388335-b7c7-4718-8bc5-0550b5e86e0e/AcglLxz5JT.json"
)
...
@st.cache_resource
def load_model():
    model = tf.keras.models.load_model("/Users/rishitha/skinsense/two/model/my_model.keras")
    return model
...
st_lottie(lottie_predict, height=300, key="predict")