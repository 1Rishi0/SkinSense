...
lottie_info = load_lottieurl(
    "https://lottie.host/df7326b2-c532-4d9a-bb65-57689d664bbd/2YE6xfLH64.json"
)

# st.title("Main Page")
st.title("Learn More")
st_lottie(lottie_info, height=300, key="disease")
st.subheader(
...
def load_image(image_path: str):
    ...
    try:
        ...
        st.error(f"Cannot identify image file: {image_path}")
...
with st.container(border=True):
    ...
    with cols[1]:
        st.image(
            "/Users/rishitha/skinsense/two/images/Actinic_Keratosis.jpg",
...
with st.container(border=True):
    ...
    with cols[0]:
        st.image(
            "/Users/rishitha/skinsense/two/images/basal-cell-carcinoma.jpg",
...
with st.container(border=True):
    ...
    with cols[1]:
        st.image(
            "/Users/rishitha/skinsense/two/images/Dermatofibroma.jpg",
...
with st.container(border=True):
    ...
    with cols[0]:
        st.image(
            "/Users/rishitha/skinsense/two/images/Melanoma.jpg",
            caption="Melanoma",
            use_column_width=True,
        )
    with cols[1]:
...
with st.container(border=True):
    ...
    with cols[1]:
        st.image(
            "/Users/rishitha/skinsense/two/images/Nevus.jpg",
            caption="Nevus",
            use_column_width=True,
        )
...
with st.container(border=True):
    ...
    with cols[0]:
        st.image(
            "/Users/rishitha/skinsense/two/images/Seborrheic.jpg",
...
with st.container(border=True):
    ...
    with cols[1]:
        st.image(
            "/Users/rishitha/skinsense/two/images/Squamous.jpg",
...
with st.container(border=True):
    ...
    with cols[0]:
        st.image(
            "/Users/rishitha/skinsense/two/images/Vascular.jpg",
